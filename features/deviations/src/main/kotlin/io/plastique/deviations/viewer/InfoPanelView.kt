...
class InfoPanelView(context: Context, attrs: AttributeSet?) : ConstraintLayout(context, attrs) {
    ...
    init {
        ...
        binding.buttonComments.setOnClickListener { onCommentsClick(CommentThreadId.Deviation(state!!.deviationId)) }
        binding.buttonFavorite.setOnClickListener { view -> onFavoriteClick(state!!.deviationId, (view as Checkable).isChecked) }
        binding.buttonInfo.setOnClickListener { onInfoClick(state!!.deviationId) }
    }
